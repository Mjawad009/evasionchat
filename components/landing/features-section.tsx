...
const features = [
  ...
  {
    number: "02",
    title: "Open for business, 24 hours a day",
...
function ParticleVisualization() {
  ...
  useEffect(() => {
    ...
    // Only animate while this canvas is actually visible — avoids burning
    // main-thread time on an off-screen animation.
...
export function FeaturesSection({ showHeader = true }: { showHeader?: boolean }) {
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
          ...
          <div className="grid lg:grid-cols-12 gap-8 items-end">
            ...
            <div className="lg:col-span-5 lg:pb-4">
              <p className={`text-xl text-muted-foreground leading-relaxed transition-all duration-1000 delay-200 ${
                ...
                Feed it your website, PDFs, and FAQs. It learns your business in minutes — and never stops working.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="grid lg:grid-cols-12 gap-4 lg:gap-6">
          ...
          >
            ...
            {/* Right: product UI preview, full height */}
