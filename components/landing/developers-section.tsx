...
const features = [
  ...
  { 
    ...
    description: "See every customer conversation as it happens."
  },
  { 
  ...
  { 
    ...
    description: "Try every answer yourself before customers ever see it."
  },
];
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        >
          <p className="text-xl text-muted-foreground mb-12 leading-relaxed max-w-md">
            Upload your content and you&apos;re live — no developer required.
            If your team wants more control, a full API is there when you need it.
          </p>
